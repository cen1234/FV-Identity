                ...
                <el-container>
                    ...
                    <el-main class="main-content">
                        ...
                        <div class="upload-img" v-if="this.active < 2">
                            ...
                            <div class="tip">点击+号上传要识别的图片，图片支持jpg/png格式，大小不超过2M,长宽比3:1,其中宽度在4069px-30px之间,图片内容为单个果蔬，上传成功后点击入库。</div>
                            <div v-if="imageUrl" class="delete" >
                                ...
                                <el-button type="primary" icon="el-icon-s-platform" style="margin-left: 10px;" @click="storage()">入库</el-button>
                            </div>
                        </div>
                    </el-main>
                </el-container>
